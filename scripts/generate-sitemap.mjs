 ...
 *
 * <lastmod> comes from scripts/lastmod.json (per-page git history, generated by
 * scripts/generate-lastmod.mjs). Routes without an entry there get no <lastmod>
...
const LASTMOD_FILE = resolve("scripts/lastmod.json");
