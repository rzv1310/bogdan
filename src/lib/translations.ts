...
export const translations = {
  ...
  en: {
    ...
    navServices: {
      "criminalitate-economica": "Financial crime",
      "infractiuni-de-coruptie-si-fapte-legate-de-exercitarea-functiei-publice": "Corruption and public office offenses",
      "investigatii-privind-activele-cripto": "Crypto asset investigations",
      "cauze-penale-privind-droguri": "Drug-related criminal cases",
      "spalare-de-bani-si-ascundere-de-bunuri": "Money laundering and asset concealment",
      ...
      "raspundere-penala-incidente-locul-de-munca": "Criminal liability for workplace incidents",
      "reprezentarea-victimelor-in-procese-penale": "Representation of victims in criminal cases",
    },
