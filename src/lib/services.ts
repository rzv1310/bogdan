export const services = [
  ...
  { label: "Malpraxis medical", to: "/servicii/neglijenta-profesionala-si-malpraxis" },
...
export const servicesEn = [
  ...
  { label: "Criminal cases regarding drugs", to: "/en/services/drug-offenses" },
  { label: "Cases of money laundering and concealment of assets", to: "/en/services/money-laundering-and-asset-concealment" },
  { label: "Medical malpractice", to: "/en/services/professional-negligence-and-malpractice" },
