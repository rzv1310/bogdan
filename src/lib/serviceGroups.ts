...
export const roServiceGroups: ServiceGroup[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        subServices: [
          { label: "Reținere 24 ore" },
          { label: "Arest preventiv" },
          { label: "Control judiciar" },
          { label: "Arest la domiciliu" },
        ],
...
export const enServiceGroups: ServiceGroup[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        subServices: [
          { label: "24-hour detention" },
          { label: "Pre-trial detention" },
          { label: "Judicial control" },
          { label: "House arrest" },
        ],
