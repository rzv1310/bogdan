  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        subServices: [
          { label: "Despăgubiri malpraxis medical" },
          { label: "Răspundere penală medic" },
          { label: "Comisia de malpraxis" },
          { label: "Vătămare corporală din culpă medicală" },
          { label: "Ucidere din culpă medicală" },
          { label: "Plângere Colegiul Medicilor" },
          { label: "Malpraxis stomatologic" },
        ],
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        subServices: [
          { label: "Medical malpractice compensation" },
          { label: "Criminal liability of doctors" },
          { label: "Malpractice committee" },
          { label: "Bodily injury from medical negligence" },
          { label: "Manslaughter from medical negligence" },
          { label: "Complaint to the Medical College" },
          { label: "Dental malpractice" },
        ],
