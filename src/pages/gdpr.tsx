...
export default function GDPR() {
  useSEO({
    keywords: "politica GDPR avocat, protectia datelor personale, confidentialitate date clienti",
  ...
  const jsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "GDPR", item: "https://avocatpenalbucuresti.ro/gdpr" },
    ],
  };
    ...
    <main className="mx-auto max-w-5xl px-4 md:px-6 py-10">
      ...
      <article className="prose prose-neutral max-w-none">
        ...
        <section>
          ...
          <p>
            Această Politică de confidențialitate va intra în vigoare începând cu 16 august 2025.
          </p>
          <p>
