...
export default function PoliticaCookies() {
  ...
  const jsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Politica cookie-uri", item: "https://avocatpenalbucuresti.ro/politica-cookies" },
    ],
  };
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 md:px-6 py-10">
      <header className="mb-8">
        <h1 className="text-2xl font-semibold">Politica de Cookie-uri</h1>
