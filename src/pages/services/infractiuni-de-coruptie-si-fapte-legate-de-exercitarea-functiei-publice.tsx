...
export default function CoruptieSiFunctiePublica() {
  useSEO({
    title: "Infracțiuni de corupție și fapte legate de exercitarea funcției publice",
    description: "Apărare în cauze privind corupția și fapte asociate funcției publice.",
  });
