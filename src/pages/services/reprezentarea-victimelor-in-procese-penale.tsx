  ...
  return (
    <section className="mx-auto max-w-6xl px-4 md:px-6 py-8">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        <Button asChild variant="premium" size="lg" aria-label="Sună acum pentru consultanță victime">
      ...
      <Card className="mt-8 border-accent">
        ...
        <CardContent className="text-base leading-relaxed space-y-3">
          <ol className="list-decimal pl-6 space-y-3">
            ...
            <li>
              <strong>Asistență pentru drepturile victimei.</strong> Configurez strategia de parte vătămată / parte civilă, valorificând drepturile prevăzute de Codul de procedură penală (art. 84–85 CPP – consultarea dosarului, formularea de cereri/excepții, adresarea de întrebări, administrarea probelor). (<a href="https://legislatie.just.ro" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2">Portal Legislativ</a>)
            </li>
          </ol>
        </CardContent>
      </Card>
