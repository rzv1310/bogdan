        ...
        <CardContent className="text-base leading-relaxed space-y-2">
          ...
          <p className="pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-md border border-accent bg-accent/10 text-muted-foreground px-3 py-1.5 text-sm font-medium hover:bg-accent/20 transition-colors"
