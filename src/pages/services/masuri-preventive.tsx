    ...
    <section className="mx-auto max-w-6xl px-4 md:px-6 py-8">
      ...
      <div className="space-y-3 text-base leading-relaxed text-muted-foreground">
        <p className="text-foreground">
          ...
          <span className="block">Dacă ție sau unei persoane apropiate vi s-a comunicat că urmează o măsură preventivă sau măsura a fost deja dispusă, timpul disponibil pentru pregătirea apărării poate fi foarte scurt.</span>
        </p>
      </div>
