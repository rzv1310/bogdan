    ...
    <section className="mx-auto max-w-6xl px-4 md:px-6 py-8 flex flex-col">
      ...
      <div className="mt-5">
        <Button asChild size="lg" variant="premium" className="whitespace-normal h-auto min-h-11 w-full py-2.5 text-sm md:w-auto md:whitespace-nowrap md:h-11 md:py-0 md:text-base">
          <a href="tel:+40745506443" aria-label="Sună-mă acum - +40 745 506 443">
            <Phone /> Sună-mă acum - +40 745 506 443
          </a>
        </Button>
      </div>
      ...
      <div className="mt-8 max-w-3xl">
        <Card className="bg-[#faf0e6]">
          ...
          <CardContent className="pt-6">
            <form onSubmit={onSubmit} noValidate aria-busy={status.type === "sending"} className="grid gap-4" name="contact-ro" method="POST" data-netlify="true" netlify-honeypot="company-website">
              {/* Hidden field for Netlify Forms (required for React/SPA) */}
              <input type="hidden" name="form-name" value="contact-ro" />
              
              {/* Honeypot anti-spam */}
              <div className="hidden" aria-hidden="true">
                <label htmlFor="company-website">Don't fill this out if you're human</label>
                <input id="company-website" name="company-website" autoComplete="off" tabIndex={-1} value={website} onChange={(e) => setWebsite(e.target.value)} />
              </div>
