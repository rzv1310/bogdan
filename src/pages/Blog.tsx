  ...
  return (
    <section className="mx-auto max-w-6xl px-4 md:px-6 py-8">
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <article>
          <Card className="transition-all hover:shadow-lg border-transparent bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--primary-glow))] text-hero-foreground hover-scale">
            <CardHeader>
