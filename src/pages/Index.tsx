...
const translations = {
  ro: {
    ...
    services: [{
      title: "DREPT PENAL",
      body: "Am o vastă experiență în reprezentarea clienților în fața tuturor instanțelor de judecată, începând cu cele cu grad de jurisdicție inferior și până la Înalta Curte de Casație și Justiție, precum și la toate nivelurile unităților de parchet de pe lângă instanțele de judecată (de la instanțe ordinare până la Înalta Curte de Casație și Justiție, inclusiv structuri specializate – Direcția Națională Anticorupție, Direcția de Investigare a Infracțiunilor de Criminalitate Organizată și Terorism și Parchetul European). Cele mai multe dintre cazurile mele prezintă un grad ridicat de complexitate, incluzând documentație voluminoasă și activități de cercetare pluridisciplinară."
    }, {
      title: "Apărare în cauze de criminalitate economică",
      body: "Reprezint persoane fizice și juridice în dosare privind fraude, delapidare, fals și evaziune fiscală. Abordarea mea îmbină cunoștințe aprofundate despre mecanismele economice cu o solidă expertiză juridică."
    }, {
      title: "Reprezentare în infracțiuni de corupție și fapte legate de exercitarea funcției publice",
      body: "Acord consultanță și apăr clienți acuzați de dare sau luare de mită, abuz în serviciu, trafic de influență, obținere nelegală de foloase și conflict de interese, asigurând o abordare discretă și strategică pe tot parcursul procedurii."
    }, {
      title: "Asistență juridică în investigații privind activele cripto",
      body: "Gestionez cauze ce implică tranzacții ilicite cu criptomonede, dețineri nedeclarate de active digitale și fraude asociate tehnologiilor blockchain — un domeniu în continuă evoluție, ce necesită atât claritate juridică, cât și înțelegere tehnică."
    }, {
      title: "Reprezentare în cauze penale legate de droguri",
      body: "Apăr clienți acuzați de deținere, trafic de droguri sau conducere sub influența substanțelor psihoactive, asigurând respectarea deplină a garanțiilor procedurale și a standardelor probatorii."
    }, {
      title: "Apărare în dosare de spălare de bani și ascundere de bunuri",
      body: "Reprezint clienți în investigații și procese privind ascunderea sau spălarea produselor provenite din activități infracționale, oferind o apărare solidă în contexte financiare complexe."
    }, {
      title: "Gestionarea cazurilor de neglijență profesională și malpraxis",
      body: "Acord asistență profesioniștilor (din domeniul medical, juridic sau tehnic) acuzați de răspundere penală ca urmare a unor erori sau încălcări ale îndatoririlor de serviciu, construind apărări bine documentate și fundamentate tehnic."
    }, {
      title: "Reprezentare în infracțiuni rutiere cu victime",
      body: "Reprezint clienți în cazuri de accidente rutiere grave, inclusiv cele soldate cu vătămări corporale sau deces, tratând cauza cu rigoare juridică și înțelegere umană."
    }, {
      title: "Răspundere penală pentru incidente la locul de muncă",
      body: "Acord consultanță și apăr persoane fizice sau juridice acuzate în legătură cu accidente de muncă, încălcări ale normelor de securitate sau neglijență a angajatorului, mai ales în cazurile cu consecințe penale."
    }, {
  ...
  en: {
    ...
    services: [{
      title: "CRIMINAL LAW",
      body: "I have extensive experience representing clients before all courts of law, from lower jurisdiction courts to the High Court of Cassation and Justice, as well as before all levels of the prosecutor’s offices attached to the courts (including specialized structures – the National Anticorruption Directorate, the Directorate for Investigating Organized Crime and Terrorism, and the European Public Prosecutor’s Office). Most of my cases are highly complex, involving extensive documentation and multidisciplinary research."
    }, {
      title: "Defense in financial crime cases",
      body: "I represent individuals and companies in cases involving fraud, embezzlement, forgery, and tax evasion. My approach combines deep knowledge of economic mechanisms with strong legal insight."
    }, {
      title: "Representation in corruption and public office-related offenses",
      body: "I advise and defend clients facing allegations such as bribery, abuse of office, influence peddling, unlawful financial benefits, and conflict of interest, ensuring a discreet and strategic approach throughout."
    }, {
      title: "Legal support in crypto-asset–related investigations",
      body: "I handle cases involving illicit crypto transactions, undeclared digital asset holdings, and fraud involving blockchain technologies — a fast-evolving field that requires both legal clarity and technical understanding."
    }, {
      title: "Representation in drug-related criminal cases",
      body: "I defend clients accused of drug possession, trafficking, and driving under the influence of psychoactive substances, ensuring full respect of procedural safeguards and evidentiary standards."
    }, {
      title: "Defense in money laundering and asset concealment proceedings",
      body: "I represent clients in investigations and trials concerning the concealment or laundering of proceeds derived from criminal activity, offering a robust defense in complex financial contexts."
    }, {
      title: "Handling cases of professional negligence and malpractice",
      body: "I assist professionals (medical, legal, or technical) charged with criminal liability arising from errors or breaches of duty, building well-documented and technically grounded defenses."
    }, {
      title: "Representation in road traffic offenses resulting in injury or death",
      body: "I represent clients in cases involving serious traffic accidents, including those leading to bodily harm or fatality, ensuring that the case is addressed with both legal precision and human understanding."
    }, {
      title: "Criminal liability in workplace-related incidents",
      body: "I advise and defend individuals or legal entities charged in relation to work accidents, safety breaches, or employer negligence, particularly where criminal consequences are pursued."
    }, {
      title: "Representation of victims in criminal proceedings",
      body: "I also assist injured parties in seeking compensation for harm caused by criminal acts, including traffic accidents, medical malpractice, and other personal or material damage. This includes legal representation before investigative and judicial authorities, as well as assistance during negotiations aimed at amicable settlements and fair compensation."
    }]
  }
} as const;
  ...
  return <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-4 md:px-6 py-12 md:py-16" aria-label="Recenzii clienți">
          <h2 className="text-3xl font-semibold mb-4">Recenzii</h2>
          <ReviewsCarousel3D
            reviews={[
