    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <ServiceFaq
          ...
          items={[
            {
              q: "Is 0.80 g/l alcohol in blood always a crime?",
              a: "Yes, above the threshold it falls under art. 336(1); under the threshold we discuss contravention (Road Code). For drugs, the biologically/toxicologically confirmed influence matters.",
            },
            {
              q: "What if I refuse to provide biological samples?",
              a: "It is a separate offense (art. 337), even if the BAC would have been below the threshold.",
            },
            {
              q: "When is leaving the scene not an offense?",
              a: "The law provides limited situations (e.g., transporting the injured with immediate return).",
            },
          ]}
        />
