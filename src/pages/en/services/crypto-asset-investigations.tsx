    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <ServiceFaq
          ...
          items={[
            {
              q: "Is \"crypto\" legal in Romania?",
              a: "Yes. It is not legal tender, but holding/trading is allowed; MiCA/TFR, Law 129/2019, the Criminal Code and the Tax Code apply; authorities (NBR/ASF/FIU/ANAF) have distinct roles.",
            },
            {
              q: "Can a lawyer help me recover funds?",
              a: "Yes - I act both criminally (complaint, precautionary measures) and civilly (claims), use requests to exchanges, chain analytics and international cooperation (e-CODEX/e-EDES).",
            },
            {
              q: "I'm a crypto entrepreneur - what should I have done \"yesterday\"?",
              a: "Do a MiCA/TFR gap assessment, risk-based KYC, sanctions screening, incident-response procedures, staff training, and prepare documentation for authorizations/registrations. The ASF has signaled the need for a national competence framework.",
            },
          ]}
        />
        <section className="mt-8">
