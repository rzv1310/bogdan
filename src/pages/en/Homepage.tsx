          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6 pt-[30px] pb-16 md:pt-12 md:pb-24 grid md:grid-cols-2 gap-10 md:gap-12 items-center">
            <div className="md:order-1">
              ...
              <div className="mt-4 block md:hidden">
                <img src="/lovable-uploads/avocat_drept_penal_Bucuresti_Bogdan_Lamatic.png" alt="Criminal defense attorney in suit, studio portrait" title="Criminal defense attorney Bucharest Bogdan Lamatic" fetchPriority="high" className="w-full h-auto rounded-lg shadow-md max-w-[68%] mx-auto" />
              </div>
            ...
            <div className="md:order-2 hidden md:flex justify-center">
              <img src="/lovable-uploads/avocat_drept_penal_Bucuresti_Bogdan_Lamatic.png" alt="Criminal defense attorney in suit, studio portrait" title="Criminal defense attorney Bucharest Bogdan Lamatic" fetchPriority="high" className="w-full h-auto rounded-lg shadow-2xl max-w-sm" />
            </div>
          </div>
        </section>
