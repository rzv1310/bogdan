...
const HomepageEN = () => {
  ...
  useSEO({
    keywords: "criminal lawyer bucharest, criminal defense attorney romania, white collar crime lawyer",
        ...
        <section id="hero" className="bg-hero text-hero-foreground">
          <div className="mx-auto max-w-6xl px-4 md:px-6 pt-[30px] pb-16 md:pt-12 md:pb-[66px] grid md:grid-cols-2 gap-10 md:gap-12 items-center">
            <div className="md:order-1">
              <h1 className="text-[26px] md:text-4xl font-semibold leading-tight tracking-tight mb-6 py-0">
              ...
              <div className="mt-4 block md:hidden relative max-w-[68%] mx-auto">
                <Legal500BadgeStrip />
                <img src="/lovable-uploads/avocat_drept_penal_Bucuresti_Bogdan_Lamatic.webp" alt="Criminal defense attorney in suit, studio portrait" title="Criminal defense attorney Bucharest Bogdan Lamatic" fetchPriority="high" className="w-[95%] h-auto rounded-lg shadow-md mx-auto" />
              </div>
              ...
              <blockquote className="border-l-4 border-accent pl-4 md:pl-6 italic text-[17px] md:text-xl text-hero-foreground/90">
               ...
               <p className="md:hidden mt-2 text-[18px] italic font-light font-signature text-right whitespace-nowrap py-[11px] px-[22px]">
                 {t.heroAuthor}{" "}
                 <span className="text-base text-hero-foreground/80">- 18 years by your side !</span>
               </p>
